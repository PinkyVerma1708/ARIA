...
import utils.Log;
public class Verifyplan_update {
	
	private TestSessionInitiator tsi;
	/**
	This method is to Swap the plans .
	*/
...
/**
This test case is to Add plan to Opportunity .
*/
@Test(priority=4)
...
/**
This test case is to Add Billing group .
*/
...
/**
This test case is to Select plan under billing group .
*/
@Test(priority=6)
...
/**
This test case is to create another opp and swap plan .
*/
@Test(priority=7)
public void Swap_plan(){
	tsi.midtermplan.click_midplan_Add_Modify_Button();
	tsi.swap_midterm.swapplan_config(DataIO.get("swapplan", "TestData"));
	tsi.swap_midterm.swapplan_commit();
}
